...
>
> However, capturing connection details as REST requests in your source code allows to describe your connector setup in a reproducible way and in conjunction with your script development efforts and RCS configuration.
...
To try the above, you can invoke the test script by POSTing a `test` action request to the connector endpoint in the IDM REST: `/openidm/system/<connector-name>?_action=test`.
